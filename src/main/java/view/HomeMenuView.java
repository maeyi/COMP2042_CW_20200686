...
public class HomeMenuView extends JComponent implements MouseListener, MouseMotionListener {
    ...
    private static final Color BORDER_COLOR = new Color(200,8,21); //Venetian Red/*package view;
...
public class HomeMenuView extends JComponent implements MouseListener, MouseMotionListener {
    ...
    private AudioPlayer audio = new AudioPlayer("HomeMusic.wav");
...
public class HomeMenu extends JComponent implements MouseListener, MouseMotionListener {
    ...
    Toolkit t=Toolkit.getDefaultToolkit();
    private Image BgPic = t.getImage("src/BgPic.jpg");//background picture in home menu
     ...
     * @param area
     */
    public HomeMenu(GameFrameModel owner, Dimension area){
    ...
    public void drawMenu(Graphics2D g2d)
    {
        ...
        g2d.drawImage(BgPic, 1, 1, (int) (menuFace.getWidth()), (int) (menuFace.getHeight()), this);
